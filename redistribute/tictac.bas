1X=RND(-TIMER):ONBRKGOTO1000:RGB:WIDTH40:PALETTE0,0:PALETTE9,25:DIMA(9),B(4),C(24),D(4),E(4):FORI=1TO24:READC(I):NEXTI:FORI=1TO4:READB(I):NEXTI:FORI=1TO4:READD(I):NEXTI
...
308NEXTI:RETURN
400M=0:W=0:B=0:FORI=1TO22 STEP3:N=0:X=0:O=0:E=0:FORJ=I TO I+2:IFA(C(J))=56 THENX=X+1:N=N+1
401IFA(C(J))=47 THENO=O+1:N=N+1
402IFA(C(J))=0 THENE=C(J)
403NEXTJ:IFN<3AND O=2 THENW=E
404IFN<3AND X=2 THENB=E
405NEXTI:IFW>0 THENM=W:F$="WIN":RETURN
406IFB>0 THENM=B:F$="BLOCK"
407RETURN
