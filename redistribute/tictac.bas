1X=RND(-TIMER):ONBRKGOTO1000:RGB:WIDTH40:PALETTE0,0:PALETTE9,25:DIMA(9),C(24):FORI=1TO24:READC(I):NEXTI
...
300N=0:FORI=1TO22 STEP3:X=0:O=0:FORJ=I TO I+2:V=A(C(J)):IFV>0 THENN=N+1
301IFV=56 THENX=X+1
302IFV=47 THENO=O+1
303NEXTJ:IFX=3OR O=3 THENRETURN
304NEXTI:RETURN
400M=0:FORI=1TO22 STEP3:N=0:X=0:O=0:E=0:FORJ=I TO I+2:IFA(C(J))=56 THENX=X+1 ELSE IF A(C(J))=47 THENO=O+1
401IFA(C(J))=0 THENE=C(J) ELSEN=N+1
